...
<body>
  <br> <br>
    ...
    <div class="col-md-6 col-11">
        <div class="panel">
            <hr>
            <h4 style="font-family: 'Roboto Slab', serif; text-align: center;;">Terima Kasih sudah melakukan rangkaian test ini</h4>
            <h4 style="font-family: 'Roboto Slab', serif; text-align: center;;">Tetap dirumah, jaga kebersihan dan jaga kesehatan ya!!</h4>
