...
<body>
  <br> <br>
    ...
    <div class="col-md-6 col-11">
        <div class="panel">
            <hr>
            <h4 style="font-family: 'Roboto Slab', serif; text-align: center;">Berdasarkan gejala gejala yang kamu rasakan, kamu adalah ODP</h4>
              <h4 style="font-family: 'Roboto Slab', serif; text-align: center;">Silahkan pergi ke Rumah Sakit terdekat untuk memastikan kamu baik baik saja</h4>
